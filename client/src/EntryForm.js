...
validateForm(){
  ...
  render() {
    const idxFields0 = {claimantName: {value: this.state.claimantName, required: true}, 
    address1: {value: this.state.address1, required: true}, 
    city1: {value: this.state.city1, required: false}, 
    state1: {value: this.state.state1, required: false}, 
    zip1: {value: this.state.zip1, required: false} 
    }
    const formFields =  [
