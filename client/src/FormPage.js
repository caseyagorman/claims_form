...
const FormPage = props => (
  ...
  >
    <form onSubmit={e=>props.handleTestClick(e,  props.idx)}>
      <input onChange={props.handleChange} style= {{ width: 800, height: 200, fontSize: 60, textAlign: "center"}}type={props.displayField(props.formFields[props.idx]).type} name={props.displayField(props.formFields[props.idx]).name} 
